...
const FeatureIconContainer = styled.div`
  ${tw`mx-auto inline-block border border-black text-center rounded-full p-2 flex-shrink-0`}
  svg {
    ${tw`w-5 h-5 text-black`}
  }
`;

const FeatureText = tw.div`mt-4 md:mt-0 md:ml-4 text-center md:text-left`;
const FeatureHeading = tw.div`font-bold text-lg text-red-700`;
