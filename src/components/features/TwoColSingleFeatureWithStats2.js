...
const Subheading = tw(SubheadingBase)`text-center md:text-left text-red-700`;
const Heading = tw(
  SectionHeading
...
const Value = tw.div`font-bold text-lg sm:text-xl lg:text-2xl text-black tracking-wide`;
...
export default ({
  ...
  heading = (
    <>
      We have been doing this <wbr /> since <span tw="text-red-700">1999.</span>
    </>
  ),
  description = "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.",
  primaryButtonText = "Learn More",
  primaryButtonUrl = "http://request.com.ar/",
